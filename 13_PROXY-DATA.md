...
*Environment: Max 20x ($200/mo), Opus 4.6 1M, v2.1.91, Linux (ZBook Ultra), single machine. cc-relay proxy: 17,610 requests (April 1-8), SQLite 22.5 MB. JSONL corpus: 1,735+ files (532 in last 7 days), 158.3 MB. Data collection ongoing — numbers will increase with continued usage.*
